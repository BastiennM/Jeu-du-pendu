...
class Game:
    ...
    def openWindow(self):
        ...
        first_menu.add_command(label="Gestion des mots",
                               command=two_funcs(self.window.destroy, GestionMot.openWindow(self)))
        ...
        lbl = Label(frame_mot, text=HangMan.motenprogres(self.hangman), font="Times 15 bold")
