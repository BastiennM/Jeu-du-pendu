...
class Aide:
    ...
    def openWindow(self):
        ...
        frame_Tt.place(x=80, y=60, width=824, height=700)

        label_title = Label(frame_Tt,
                            text="Voici la page aide\n Si vous avez quleques problèmes, les réponses sont ici",
                            font=("Arial", 30), bg="#ccccff", fg="black")
        label_title.pack()
        label_dif = Label(frame_Tt, text="\n\nLa difficulté :", font=("Arial", 20), bg="#ccccff", fg="black")
        label_dif.pack()
        label_expDIf = Label(frame_Tt,
                             ...
                             font=("Arial", 12), bg="#ccccff", fg="black")
        label_expDIf.pack()
        label_Faci = Label(frame_Tt,
                           text="Facile : 5 points bonus \nMoyen : 10 points bonus\nDifficile : 15 points bonus\n\n",
                           font=("Arial", 12), bg="#ccccff", fg="black")
        label_Faci.pack()
        label_score = Label(frame_Tt, text="Le score :", font=("Arial", 20), bg="#ccccff", fg="black")
        label_score.pack()
        ...
        label_Mess = Label(frame_Tt, text="\nA vous de jouer !!!", font=("Arial", 20), bg="#ccccff", fg="black")
        label_Mess.pack()
